...
# Naming Nodes
We already christened our nodes during [Base OS Installation](/BuildingAtlas/InstallingBaseOS). But the nodes only know each other by their IPs. It is immensely helpful if they'd know each other by their names.
