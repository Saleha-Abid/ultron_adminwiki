...
1. Go to [this Github Repository](https://github.com/Saleha-Abid/ultron.git). Check the `monitoring` folder for a `grafana-dashboards`. You'll find the JSON files. Download them.
